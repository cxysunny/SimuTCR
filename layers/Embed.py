...
class FixedAbsolutePositionEmbedding(nn.Module):
    def __init__(self,c_in,d_model, embed,freq,drop_out = 0.1,max_position_embeddings = 1000,alpha = 1,base = 10000, position_embedding_type = 'rope',emb_x=True):
        super().__init__()
        self.emb_x = emb_x
...
class DataEmbedding_normal(nn.Module):
    def __init__(self, c_in, d_model, embed_type='fixed', freq='h', dropout=0.1):
        super(DataEmbedding_wo_pos, self).__init__()
