...
def evaluate(model, dataloader, device):
    ...
    plt.tight_layout()
    plt.savefig('/home/xycui/project/af3_binding/results/seq_plus_structure_9.23/epoch10bg.png')
    plt.close()
...
def main():
    ...
    # 配置路径
    test_csv = "/home/xycui/project/af3_binding/dataset/test_healthytcr.csv"
    test_dir = "/home/xycui/project/af3_binding/dataset/test_healthytcr"
    ...
    df.to_csv('/home/xycui/project/af3_binding/results/' + model_name + '/'+epoch_name+'bg.csv', index=False)
