...
# all_results = pd.read_csv('/home/xycui/tcrbind/ROCunseen/epact3unseen.csv',header=None)
# all_results = pd.read_csv('/home/xycui/tcrbind/Randomunseen/epactran4.csv',header=None)
all_results = pd.read_csv('/home/xycui/tcrbind/Background/epact4.csv',header=None)

positive_predictions = []
negative_predictions = []
for i in range(1,len(all_results)):
    if int(all_results.iloc[i,2]) == 1:
        positive_predictions.append(float(all_results.iloc[i, 1]))
    else:
        negative_predictions.append(float(all_results.iloc[i, 1]))
...
plt.savefig('photo/predict_distribution_epact_back.svg',format = 'svg', dpi=300)
...
# plt.legend()
# plt.grid(True, alpha=0.3)
# plt.savefig('photo/predict_distribution_epact_kde.jpg', dpi=300)