...
def evaluate(model, dataloader, device):
    ...
    plt.tight_layout()
    plt.savefig('/home/xycui/project/af3_binding/results/seq_plus_structure_9.22/epoch_21overlapevaluation_curves.png')
    plt.close()
...
def main():
    ...
    model_name = "seq_only"  # 模型名称
    # 配置路径
    test_csv = "/home/xycui/project/af3_binding/dataset/test_immrep23_overlap.csv"
    test_dir = "/home/xycui/project/af3_binding/dataset/test_immrep23_overlap"
    model_weights = "/home/xycui/project/af3_binding/results/"+ model_name +"/model_weights/epoch_30.pt"
    ...
    model.moe_mhc.plot_moe(model_name+'_overlap')  
    # 保存预测结果
    df = pd.DataFrame({
    ...
    df.to_csv('/home/xycui/project/af3_binding/results/' + model_name + '/overlap.csv', index=False)
    print("Saved predictions to overlaptest_predictions.csv")
